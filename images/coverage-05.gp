...
set output "/home/runner/work/coverage-talk/coverage-talk/target/generated-slides/images/coverage-05.svg"
...
set object 10 rect from 0,-0.06 to 1,-0.01 fc rgb "#F2B8B5" fs solid 1.0 border rgb "#777777" lw 2

# Green projected intervals
set object 11 rect from 0.01,-0.06 to 0.16,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2
set object 12 rect from 0.34,-0.06 to 0.47,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2
set object 13 rect from 0.65,-0.06 to 0.74,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2
set object 14 rect from 0.8,-0.06 to 0.88,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2

# Labels
set label 1 "Full space of program execution paths" at screen 0.095, screen 0.6 rotate by 90 center font ",36"
set label 2 "code cov. = 45.00%, full space cov. = 5.12%" at 0.5,-0.09 center font ",36"
