...
set output "/home/runner/work/coverage-talk/coverage-talk/target/generated-slides/images/coverage-04.svg"
...
set object 5 rect at 0.74,0.36 size 0.08,0.08 fc rgb "#4F81BD" fs solid 0.35 border rgb "#4F81BD" lw 2
...
set object 6 rect from 0,-0.06 to 1,-0.01 fc rgb "#F2B8B5" fs solid 1.0 border rgb "#777777" lw 2

# Green projected intervals
set object 7 rect from 0.08,-0.06 to 0.16,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2
set object 8 rect from 0.34,-0.06 to 0.47,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2
set object 9 rect from 0.7,-0.06 to 0.78,-0.01 fc rgb "#70AD47" fs solid 0.85 border rgb "#70AD47" lw 2

# Labels
set label 1 "Full space of program execution paths" at screen 0.095, screen 0.6 rotate by 90 center font ",36"
set label 2 "code cov. = 29.00%, full space cov. = 2.56%" at 0.5,-0.09 center font ",36"
